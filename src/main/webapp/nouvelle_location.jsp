...
<div class="relative flex items-center justify-center min-h-screen">
    ...
    <a href="${pageContext.request.contextPath}/LocationServlet"
       class="absolute top-4 right-4 text-gray-400 hover:text-red-600 transition duration-200 text-3xl z-50"
       title="Fermer la page" aria-label="Fermer">
